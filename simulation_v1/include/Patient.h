...
class Patient{
    public:
        ...
        Patient(int arrival_time, int pathway, int base_duration, double service_red_beta, int service_red_cap, double ext_prob_cap,
        ...
        void set_serv_red_beta(double d);
        void set_serv_red_cap(int c);
